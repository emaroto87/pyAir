...
def Fcci_seg(
    ...
    x = b/t * math.sqrt(Fty/(K*E))

    if x <= xs:
        Fcci_seg = Fty *(y0 - m * beta)
    else:
        Fcci_seg = Fty * alpha / (x**n)
...
# Ejemplo 1 del manual de Crippling : Perfil en Omega
Al_7075_T6_Clad = Metallic(
    name = 'AL_7075',
    norm = None,
    shape = 'Sheet',
    temp_treat = 'T6', 
...
seg1 = [cripp_segment(15.0,1.0,2.5,0,True,True)]
# seg2 = [cripp_segment(22.0,1.6,3.2,0,True,True)]
print(crippling_strength(Al_7075_T6_Clad, seg1))