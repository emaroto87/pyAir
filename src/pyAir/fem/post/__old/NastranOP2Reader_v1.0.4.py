...
__releaseDateLong__ = 'December 03, 2025'
...
ENVELOPE_OPTIONS = ('MAX','MIN','EXTREME','MAX_ABS','QHULL','AVERAGE','NONE')
    ...
    for label, group in groups.items():
        ...
        # ENVELOPE : AVERAGE
            ...
            for subcase in tqdm(subcases):
                ...
                table_per_subcase = raw_group_table[raw_group_table['SubcaseID'].isin([subcase])]
...
os.chdir(r'C:\Users\U69432\Desktop\WORK\01_FWD_FUS')

def gui_console(export_excel = True):
    ...
    while True:
        ...
        if link_menu.selection.upper() == 'EXIT':
            ...
            # Requesting Output Excel file path if export_excel = True
            if export_excel:
            ...
            # Askig for field 
            if not (env_type_menu.selection.upper() in  ['NONE','AVERAGE']):
...
def get_average_envelope():
    tables = gui_console(export_excel = False)
...
# Testing
# op2 = r'C:\Users\U69432\Desktop\WORK\01_FWD_FUS\10_LOWER_SW_Resizing\01_PANPA\01_GFEM\DLL_20250227_AC_DLL-LAP_FWD_FUS_GFEM_01_UL_SW_Baseline.op2'
# result_link = __RealPlateForce
# dataframe = raw_table(op2,result_link)
# subs = getattr(dataframe,'SubcaseID')
# filtered_table = dataframe[dataframe['SubcaseID'].isin([2201436])]
# filtered_table2 = dataframe[dataframe['SubcaseID'].isin([2201419])]
# mean1 = filtered_table.mean()
# mean2 = filtered_table.mean()
